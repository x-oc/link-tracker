...
public class ScrapperClientTest {
            ...
            get(urlPathMatching("/links"))
                ...
                .willReturn(aResponse()
                    ...
                    .withBody(objectMapper.writeValueAsString(new ListLinksResponse(
                        List.of(new LinkResponse(100L, URI.create("https://article.com"), null, null)),
                        1
                    )))
                )
        );
    ...
    public void linksPostShouldReturnAddedLink() {
        ...
        LinkResponse response =
            scrapperClient.addLink(100L, new AddLinkRequest(URI.create("https://article.com"), null, null)).answer();
        Assertions.assertThat(response)
    ...
    public void linksDeleteShouldReturnAddedLink() {
        ...
        ScrapperClient scrapperClient = scrapperClient();
        LinkResponse response =
            scrapperClient.removeLink(100L, new RemoveLinkRequest(URI.create("https://article.com"))).answer();
        Assertions.assertThat(response)
            .extracting(LinkResponse::id, LinkResponse::url)
            .contains(100L, URI.create("https://article.com"));
    }
        ...
        stubFor(
            get(urlPathMatching("/links"))
                ...
                .willReturn(aResponse()
                    .withStatus(404)
                    .withBody(objectMapper.writeValueAsString(
                        new ApiErrorResponse("Not found", "404",
                            "Not found", "Not found", List.of())
                    ))
                    .withHeader("Content-Type", "application/json")
                )
        );
