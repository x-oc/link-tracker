...
public class MessageHandlerTest {
    ...
    public void handleShouldExecuteCommand() {
        Assertions.assertThat(handler.handle(createMockUpdate("/mock", 1L)).getParameters().get("text"))
    ...
    public void processShouldReturnNullWhenMessageIsNull() {
        ...
        Assertions.assertThat(message.getParameters().get("chat_id"))
            .isEqualTo(1L);
    }
