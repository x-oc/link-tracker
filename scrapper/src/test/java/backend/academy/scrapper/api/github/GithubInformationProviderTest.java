...
public class GithubInformationProviderTest {
    ...
    private static final ScrapperConfig EMPTY_CONFIG = new ScrapperConfig(
        null,
        null,
        null
    );
    ...
    public static void setUp() {
        ...
        server.stubFor(get(urlPathMatching("/repos/no/nope"))
            .willReturn(aResponse()
                .withStatus(404)));
        server.start();
    ...
    public void getInformationShouldReturnCorrectInformation() {
        ...
        Assertions.assertThat(info)
            ...
            .contains(
                new URI("https://github.com/x-oc/slae-solutions"),
                "x-oc/slae-solutions"
            );
    }
